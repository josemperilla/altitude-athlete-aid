...
export const POSES = {
  squat: {
    load: 'bar', loadAt: 'sh', duration: 3000, trail: 'sh',
    weights: [1.7, 1], weightsBack: [1, 1.2], holds: [500, 0, 300],
    poses: [
  ...
  rdl: {
    load: 'bar', duration: 2800, trail: 'hand',
    weights: [1.5, 1], weightsBack: [1, 1.3], holds: [450, 0, 250],
    poses: [
  ...
  slrdl: {
    load: 'db', duration: 3000,
    weights: [1.4], weightsBack: [1], holds: [400, 300],
    poses: [
      { ankle: [52, G], shin: 0, thigh: 0, trunk: 0, uarm: 180, farm: 180, thigh2: 188, shin2: 186 },
      { ankle: [52, G], shin: -4, thigh: -38, trunk: 62, uarm: 180, farm: 180, thigh2: 250, shin2: 258, neck: -38 },
    ],
  },
  ...
  bulgarian: {
    ...
    weights: [1.6, 1], weightsBack: [1, 1.3], holds: [400, 0, 250],
    poses: [
      { ankle: [62, G], shin: 0, thigh: 0, trunk: 12, uarm: 180, farm: 180, thigh2: 228, shin2: 248, foot2: -20 },
      { ankle: [62, G], shin: 10, thigh: -30, trunk: 18, uarm: 180, farm: 180, thigh2: 212, shin2: 272, foot2: -20 },
      { ankle: [62, G], shin: 20, thigh: -58, trunk: 24, uarm: 180, farm: 180, thigh2: 195, shin2: 297, foot2: -20 },
    ],
  },
  ...
  stepup: {
    ...
    weights: [1, 1], weightsBack: [1.5, 1.5], holds: [350, 0, 250],
    poses: [
      // Pie de adelante arriba en el cajón, pie de atrás todavía en el suelo.
      { ankle: [66, 82], shin: 27, thigh: -84, trunk: 16, uarm: 180, farm: 180, thigh2: 180, shin2: 180 },
      { ankle: [66, 82], shin: 13, thigh: -42, trunk: 11, uarm: 180, farm: 180, thigh2: 190, shin2: 185 },
      // Arriba, de pie sobre el cajón, pierna libre suspendida.
      { ankle: [66, 82], shin: 0, thigh: 0, trunk: 6, uarm: 180, farm: 180, thigh2: 200, shin2: 190 },
    ],
  },
  ...
  calfsingle: {
    ...
    weights: [1, 1], weightsBack: [1.5, 1.5], holds: [300, 0, 500],
    poses: [
      { toe: [64, 96], foot: -34, shin: 3, thigh: 0, trunk: 0, uarm: 180, farm: 180, thigh2: 195, shin2: 250 },
      { toe: [64, 96], foot: 12, shin: 2, thigh: 0, trunk: 0, uarm: 180, farm: 180, thigh2: 195, shin2: 250 },
      { toe: [64, 96], foot: 56, shin: 2, thigh: 0, trunk: 0, uarm: 180, farm: 180, thigh2: 195, shin2: 250 },
    ],
  },
  ...
  legcurl: {
    mode: 'raw', duration: 2400,
    ground: false,
    weights: [1.2, 1], weightsBack: [1.4, 1.4], holds: [250, 0, 350],
    ...
    poses: [
      // Piernas extendidas, antebrazos apoyados delante del banco.
      {
        mode: 'raw',
        joints: {
          head: [16, 60], sh: [34, 68], el: [26, 80], hand: [16, 86],
          hip: [70, 72], knee: [92, 73], ankle: [114, 74],
          heel: [113, 68], toe: [118, 82],
        },
      },
      {
        mode: 'raw',
        joints: {
          head: [16, 60], sh: [34, 68], el: [26, 80], hand: [16, 86],
          hip: [70, 72], knee: [92, 73], ankle: [104, 54],
          heel: [99, 51], toe: [113, 60],
        },
      },
      // Talón al glúteo: rango completo, que es el punto del ejercicio.
      {
        ...
        joints: {
          head: [16, 60], sh: [34, 68], el: [26, 80], hand: [16, 86],
          hip: [70, 72], knee: [92, 73], ankle: [86, 52],
          heel: [81, 51], toe: [95, 57],
        },
      },
    ],
  },
  ...
  deadbug: {
    mode: 'raw', duration: 2800,
    groundY: 96,
    weights: [1.2, 1], weightsBack: [1, 1.2], holds: [350, 0, 400],
    poses: [
      // Punto de partida: brazo vertical y muslo a 90°, rodilla también a 90°.
      {
        mode: 'raw',
        joints: {
          head: [24, 88], sh: [42, 92], el: [42, 76], hand: [42, 60],
          hip: [80, 94], knee: [80, 74], ankle: [96, 68],
          heel: [92, 64], toe: [103, 73],
        },
      },
      {
        mode: 'raw',
        joints: {
          head: [24, 88], sh: [42, 92], el: [34, 78], hand: [24, 68],
          hip: [80, 94], knee: [88, 82], ankle: [104, 78],
          heel: [100, 74], toe: [111, 82],
        },
      },
      // Brazo y pierna contrarios extendidos, casi rozando el suelo.
      {
        mode: 'raw',
        joints: {
          head: [24, 88], sh: [42, 92], el: [26, 84], hand: [10, 78],
          hip: [80, 94], knee: [100, 92], ankle: [120, 91],
          heel: [116, 87], toe: [125, 95],
        },
      },
    ],
  },
  ...
  sideplank: {
    mode: 'raw', duration: 2400,
    groundY: 100,
    weights: [1.3], weightsBack: [1], holds: [300, 500],
    poses: [
      // Apoyo en antebrazo, cuerpo en línea, pierna de arriba abajo.
      {
        mode: 'raw',
        joints: {
          head: [26, 58], sh: [38, 66], el: [30, 100], hand: [48, 100],
          hip: [72, 84], knee: [94, 93], ankle: [114, 100],
          heel: [110, 96], toe: [118, 104],
          knee2: [94, 93], ankle2: [114, 100], heel2: [110, 96], toe2: [118, 104],
        },
      },
      // Pierna de arriba en abducción, por detrás de la línea del cuerpo.
      {
        ...
        joints: {
          head: [26, 58], sh: [38, 66], el: [30, 100], hand: [48, 100],
          hip: [72, 84], knee: [92, 74], ankle: [112, 66],
          heel: [108, 62], toe: [118, 70],
          knee2: [94, 93], ankle2: [114, 100], heel2: [110, 96], toe2: [118, 104],
        },
      },
    ],
  ...
  pallof: {
    ...
    weights: [1.2], weightsBack: [1], holds: [400, 400],
    poses: [
  ...
  dbpress: {
    load: 'db', duration: 2600,
    weights: [1, 1], weightsBack: [1.3, 1], holds: [300, 0, 250],
    poses: [
  ...
  row: {
    load: 'db', duration: 2400,
    weights: [1, 1.2], weightsBack: [1.2, 1], holds: [250, 0, 250],
    poses: [
  ...
  monsterwalk: {
    ...
    poses: [
      ...
      { ankle: [46, G], shin: 8, thigh: -16, trunk: 12, uarm: 190, farm: 200, thigh2: 198, shin2: 174 },
      { ankle: [46, G], shin: 8, thigh: -16, trunk: 12, uarm: 190, farm: 200, thigh2: 232, shin2: 208 },
    ],
  },
  ...
  tibialis: {
    ...
    weights: [1, 1], weightsBack: [1.2, 1], holds: [250, 0, 300],
    poses: [
  ...
  footdome: {
    mode: 'raw', duration: 2600,
    groundY: 92,
    weights: [1.3], weightsBack: [1], holds: [300, 400],
    poses: [
