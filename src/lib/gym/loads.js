...
export const WEIGHT_GUIDE = {
  squat: {
    ...
    aviso:
      "Si la técnica se rompe, vuelve al peso anterior. Semana de carrera: 2×3 al 60–65 % (~30–35 kg).",
  },
  rdl: {
    inicio:
      "Peso con el que las últimas 2 de 6 salgan duras con la espalda quieta y la cadera atrás.",
    arranque: "Arranca en 40–50 kg (barra + 10–15 kg por lado).",
  ...
  calfstanding: {
    ...
    aviso:
      "Si rebotas o no llegas completo a la punta, vuelve al pin anterior. Semana de carrera: 2×8 con un pin menos.",
  },
  calfsinglebent: {
    inicio:
  ...
  pallof: {
    ...
    aviso:
      "Si el torso rota o los hombros se suben, regresa a la banda anterior. Semana de carrera: 2×10 con banda ligera.",
  },
  monsterwalk: {
